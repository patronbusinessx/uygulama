...
export const Icon: React.FC<IconProps> = ({ name, className = "w-5 h-5" }) => {
  switch (name) {
    ...
    case 'Sliders':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <line x1="4" x2="20" y1="21" y2="21"/><line x1="20" x2="20" y1="21" y2="3"/><line x1="4" x2="4" y1="21" y2="14"/><line x1="4" x2="20" y1="10" y2="10"/><circle cx="8" cy="14" r="4"/><circle cx="16" cy="7" r="4"/>
        </svg>
      );
    default:
      return null;
